...
<body>
    <div class="header">
        <h1>🎯 Miner Strategy Trading Report</h1>
        <p>{scan_date}</p>
    </div>
...
"""
    ...
    if bullish:
        html += """
    <div class="section">
        <h2 class="section-title">📈 Top Bullish Opportunities</h2>
"""
...
"""
    ...
    if bearish:
        html += """
    <div class="section">
        <h2 class="section-title">📉 Top Bearish Opportunities</h2>
"""
...
"""
    ...
    <div class="disclaimer">
        <strong>⚠️ DISCLAIMER:</strong> This report is for educational purposes only and does not 
    ...
    <div class="setup-card {card_class}">
        ...
        <div class="metrics">
            <div class="metric">
                ...
                <div class="metric-value">₹{setup['current_price']}</div>
            </div>
            <div class="metric">
                <div class="metric-label">Entry Price</div>
                <div class="metric-value">₹{setup['entry']}</div>
            </div>
            <div class="metric">
                <div class="metric-label">Stop Loss</div>
                <div class="metric-value">₹{setup['stop']}</div>
            </div>
            <div class="metric">
        ...
        <p><strong>Risk:</strong> ₹{setup['total_risk']} ({(setup['total_risk']/1000000*100):.2f}% of ₹10L account)</p>
    </div>
"""
